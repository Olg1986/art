...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
    ...
    input.addEventListener('drop', function (e) {
      ...
      if (input.getAttribute('data-upload')) {
        ...
        _toConsumableArray(input.files).forEach(function (file) {
          ...
          Object(_services_requests__WEBPACK_IMPORTED_MODULE_10__["postData"])('assets/server.php', formData).then(function (res) {
            console.log(res);
          });
        });
      }
